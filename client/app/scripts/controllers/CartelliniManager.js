...
var CartelliniManager = function ()
{
    return {
        ...
        stampaCartellini : function (e)
        {
            ...
            {
                Utils.showError("Non è stato selezionato nessun cartellino da stampare.");
                return false;
            }
        ...
        renderCheckStampa : function (data, type, row)
        {
            return "<div class=\"input-group\">" +
                "<input type='number' min='0' step='1' value='0' class='form-control' style='width:70px' id='ck_" + row.id_cartellino + "'>" +
                "</div>";
        },
        ...
        setGridListeners : function ()
        {
            ...
            $('input[type="number"]').on("change", this.cartellinoSelezionato.bind(this));
