var PrintSheetsManager = ( function ()
{
    var CARTELLINI_PER_PAG = 6,
        ...
        MAPPA_TIPI_RICETTE = {
            ...
            "Granata": "arma_equip",
            "Arma Mischia Lunga": "arma_equip",
            "Arma Mischia Corta": "arma_equip",
            ...
            Utils.requestData(
                ...
                function ( data )
                {
                    ...
                    for ( var d in data_mapped )
                    {
                        ...
                        if ( !this.dati_cartellini[data_mapped[d].tipo_cartellino] )
            ...
            Utils.requestData(
                ...
                function ( data )
                {
                    ...
                    for ( var d in data_mapped )
                    {
                        ...
                        if ( !this.dati_cartellini.componente_consumabile )
            ...
            Utils.requestData(
                ...
                function ( data )
                {
                    ...
                    for ( var c in cartellini )
                    {
                        ...
                        if ( !this.dati_cartellini[tipo] )
                            this.dati_cartellini[tipo] = [];
