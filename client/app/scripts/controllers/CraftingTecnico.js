...
var mappa_tipi_radio_db = {
    ...
    "Arma Mischia Corta": "arma_mischia_corta",
    "Arma Mischia Lunga": "arma_mischia_lunga",
    "Granata": "granata",
    "Gadget Normale": "gadget",
    "Gadget Avanzato": "gadget",
    "Scudo": "scudo",
    "Protesi Braccio": "protesi_braccio",
    "Protesi Gamba": "protesi_gamba",
    "Protesi Generica": "protesi_generico",
...
var mappa_tipi_db_radio = {
    ...
    "scudo": "Scudo",
    "protesi_braccio": "Protesi Braccio",
    "protesi_gamba": "Protesi Gamba",
    "protesi_generico": "Protesi Generica",
    "esoscheletro": "Esoscheletro"
};
...
function searchBoxKeyUp(ev) {
    var search_box = $(ev.currentTarget),
...
$(document).ready(function() {
    ...
    loadComponentsFromDB(function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            data[i].Effetto = data[i].effetto_sicuro_componente;
...
function popoloComponenti(array, id, div) {
    array.forEach(function(el) {
        ...
        if (el.Effetto)
            content.append('<p class="descrizione_comp">' + el.Effetto + '</p>');
